  ...
  function (
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      getConfig:function(){
        ...
        this._bufferDefaults.bufferUnits = this._getAllBufferUnits();
        var config = {
      ...
      _initBufferUnitTable:function(){
        ...
        var bUnits = this.config && this.config.bufferDefaults && this.config.bufferDefaults.bufferUnits;
      ...
      _onEditOk: function () {
        ...
        this.config.bufferDefaults.bufferUnits = bufferUnits;
        this._initBufferUnitTable();
