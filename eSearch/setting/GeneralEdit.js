...
//        console.info(this.config);
        ...
        if(this.config.selectAttachmentView){
          this.selectAttachmentView.set('value', this.config.selectAttachmentView);
        }else{
          this.selectAttachmentView.set('value', 'text');
        }
      ...
      getConfig: function() {
        ...
        generalOps.selectAttachmentView = this.selectAttachmentView.get('value');
