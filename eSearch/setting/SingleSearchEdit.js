  ...
  function (
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      getConfig: function () {
        ...
        config.expressions = allSingleExpressions;
        config.links = allSingleLinks;
        config.relates = allSingleRelates;
        this._addLinkFields(config.fields.field, config.links);
      ...
      _initExpressionsTable: function () {
        ...
        var expressions = this.config && this.config.expressions;
      ...
      _initRelatesTable: function () {
        ...
        var relates = this.config && this.config.relates;
      ...
      _initLinksTable: function () {
        ...
        var links = this.config && this.config.links;
      ...
      _onServiceFetch: function(urlDijit, evt){
        ...
        if (this._checkForFeatureLayer(url)) {
          ...
          if(evt.data.type === "Table"){
            html.addClass(this.hidefortablestd1, 'visible-false');
            html.addClass(this.hidefortablestd2, 'visible-false');
            html.addClass(this.hidefortablestd3, 'visible-false');
            html.addClass(this.hidefortablestd4, 'visible-false');
            html.addClass(this.hidefortablestd5, 'visible-false');
            html.addClass(this.hidefortablestd6, 'visible-false');
            html.addClass(this.hidefortablestd7, 'visible-false');
          }else{
            html.removeClass(this.hidefortablestd1, 'visible-false');
            html.removeClass(this.hidefortablestd2, 'visible-false');
            html.removeClass(this.hidefortablestd3, 'visible-false');
            html.removeClass(this.hidefortablestd4, 'visible-false');
            html.removeClass(this.hidefortablestd5, 'visible-false');
            html.removeClass(this.hidefortablestd6, 'visible-false');
            html.removeClass(this.hidefortablestd7, 'visible-false');
          }
